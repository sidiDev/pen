...
function Logo() {
  return (
    <a
      href="/"
      className="flex items-center justify-center gap-2 self-center font-medium text-neutral-50"
    >
      <div className="bg-neutral-700 border border-neutral-600/50 flex size-8 items-center justify-center rounded-md">
        <svg
          width="20"
          height="20"
          viewBox="0 0 24 24"
